...
sSQL = "SELECT id, DATE_FORMAT(Create_Date,'%y-%m-%d %H:%i'), Phone_Number";
sSQL += " FROM callpro_account_owner_phones";
sSQL += " WHERE Main_Account_Sequence='" + sAccountSequence + "'";
sSQL += " AND Phone_Type='S'";
...
if (sResultCode.equals(gcResultCodeSuccess)){	//有資料
	...
	String[] fields2 = {"id", "Create_Date", "Phone_Number"};
